    ...
    public partial class Editor : Form
    {
        ...
        public void Update(List<GameObject> objects, Map map)
        {
                    ...
                    mode != CreateMode.Walls)
            {
                ...
                if (Input.MouseLeftClicked() && mode == CreateMode.Objects)
                {
                    ...
                    {
                        if (objects[i].CheckCollision(new Rectangle(desiredIndex.X * map.tileSize, desiredIndex.Y * map.tileSize, map.tileSize, map.tileSize)))
                        {
                    ...
                    if (desiredIndex.X >= 0 && desiredIndex.X < map.mapWidth && desiredIndex.Y >= 0 && desiredIndex.Y < map.mapHeight)
                    {
                        ...
                        if (map.CheckCollision(newWall) == Rectangle.Empty)
                        {
                            ...
                            if (oldWall == Rectangle.Empty)
                                map.walls.Add(new Wall(newWall, true));
        ...
        private void listBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (mode == CreateMode.Decor)
            {
                ...
                decorSourceX.Value = (decimal)selectedDecor.sourceRectangle.X;
                decorSourceY.Value = (decimal)selectedDecor.sourceRectangle.Y;
                decorSourceWidth.Value = (decimal)selectedDecor.sourceRectangle.Width;
                decorSourceHeight.Value = (decimal)selectedDecor.sourceRectangle.Height;
            }
        }
        ...
        private void decorSourceX_ValueChanged(object sender, EventArgs e)
        {
            ...
            game.map.decor[listBox.SelectedIndex].sourceRectangle.X = (int)decorSourceX.Value;
        }
        ...
        private void decorSourceY_ValueChanged(object sender, EventArgs e)
        {
            ...
            game.map.decor[listBox.SelectedIndex].sourceRectangle.Y = (int)decorSourceY.Value;
        }
        ...
        private void decorSourceWidth_ValueChanged(object sender, EventArgs e)
        {
            ...
            game.map.decor[listBox.SelectedIndex].sourceRectangle.Width = (int)decorSourceWidth.Value;
        }
        ...
        private void decorSourceHeight_ValueChanged(object sender, EventArgs e)
        {
            ...
            game.map.decor[listBox.SelectedIndex].sourceRectangle.Height = (int)decorSourceHeight.Value;
        }
